    ...
    return (
      <div className="flex h-screen w-full flex-col items-center justify-center bg-[#0a0a0a] overflow-hidden">
        <div className="text-center flex flex-col items-center gap-8 px-8">
          ...
          <p className="text-xs text-champagne/70 tracking-[0.25em] uppercase mt-4 animate-pulse">
              ...
              <div className="w-full lg:w-7/12 flex flex-col justify-center order-1 lg:order-2">
                ...
                <div className="mt-10 flex flex-wrap gap-8 items-center pt-8 border-t border-[#CCA43D]/25">
                  <div>
                    ...
                    <p className="text-[10px] uppercase tracking-[0.25em] mt-1 text-champagne/80 font-medium">Generations of Eyes</p>
                  </div>
                  <div className="w-[1px] h-10 bg-[#CCA43D]/25" />
                  <div>
                    <p className="text-3xl font-serif text-[#CCA43D]">90%</p>
                    <p className="text-[10px] uppercase tracking-[0.25em] mt-1 text-champagne/80 font-medium">Surat Cut Advantage</p>
                  </div>
                  <div className="w-[1px] h-10 bg-[#CCA43D]/25" />
                  <div>
              ...
              <div className="flex gap-3">
                {config.socialInstagram && (
                  <a href={config.socialInstagram} target="_blank" rel="noopener noreferrer"
                    className="w-10 h-10 border border-[#CCA43D]/40 hover:border-[#CCA43D] flex items-center justify-center text-champagne hover:text-[#CCA43D] hover:bg-[#CCA43D]/5 transition-all duration-300 hover:-translate-y-1">
            ...
            <div className="flex-shrink-0 md:pt-6">
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li key={label}>
                    <button onClick={action} className="text-champagne/80 hover:text-[#CCA43D] text-sm font-light tracking-wide transition-colors duration-300 text-left group flex items-center gap-2">
